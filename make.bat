...
C:\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -c -o game_screen.o game_screen.c
C:\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -c -o main.o main.c
C:\gbdk\bin\lcc -Wl-yt3 -Wl-yo8 -Wl-ya4 -o main.gb main.o title_screen.o kwakwa_screen.o title.o kwakwa.o game_screen.o
