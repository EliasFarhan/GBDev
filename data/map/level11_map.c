...
# include <stdlib.h>
const unsigned char Lvl11TileMap[] = {6,13,11,13,1,13,11,6,6,6,6,6,6,6,6,6,6,6,6,6,
...
const Box box_locks_lvl11_value[1] =
                {
                    {32, 96, 8, 32}
                };
SEAGULL seagull_lvl11 [] = {{{40U,96U, 6U, 9U},1,0U,0U,114U, 40U}};
