...
data/map/level7_map.o data/map/level8_map.o data/map/level9_map.o data/map/level10_map.o levels/level10.o \
data/map/level11_map.o data/map/level12_map.o data/map/level13_map.o levels/level13.o data/map/level14_map.o data/map/level15_map.o

all:	  $(LVLS) $(SOURCE) $(ASSETS) $(BONUS) $(BINS)

SRJailbreak.gb:
	$(CC) -Wl-yt0x19 -Wl-yo4 -Wl-ya0 -o $(BINS) $(LVLS) $(SOURCE) $(BONUS) $(ASSETS)
...
data/staffroll.o: data/staffroll.s
	$(CC) -Wa-l -Wf-bo3 -c -o data/staffroll.o data/staffroll_merge.s
data/kwakwa_logo.o:
...
data/title_screen_music.o:
	$(CC) -Wa-l -Wf-bo3 -c -o data/title_screen_music.o data/title_screen_music.c
...
data/music_output.o:  data/music_output.c
	$(CC) -Wa-l -Wf-bo3 -c -o data/music_output.o data/music_output.c
